    ...
    def validate_plan(self, plan, customer_profile):
        ...
        for task in plan.tasks:
            result = self.validator.validate(
                task=task.task, customer_profile=customer_profile
            )
        ...
        return {"status": "valid", "missing_fields": [], "task_results": results}

    def build_missing_question(self, validation_result):

        return self.question_generator.build_question(validation_result.missing_fields)
