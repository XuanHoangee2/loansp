...
list_of_file = [
    ...
    f"{project_name}/loan_mcp_server/tools/calculate_dti.py",
    f"{project_name}/loan_mcp_server/tools/calculate_ltv.py",
    f"{project_name}/loan_mcp_server/tools/recommend_loan.py",
    f"{project_name}/loan_mcp_server/services/dti_service.py",
    f"{project_name}/loan_mcp_server/services/ltv_service.py",
    f"{project_name}/loan_mcp_server/services/recommendation_service.py",
    f"{project_name}/loan_mcp_server/server.py",

    f"{project_name}/knowledge_mcp_server/tools/faq_search.py",
    f"{project_name}/knowledge_mcp_server/tools/policy_search.py", 
    f"{project_name}/knowledge_mcp_server/services/milvus_service.py",
    f"{project_name}/knowledge_mcp_server/services/embedding_service.py",
